...
train_loader = torch.utils.data.DataLoader(
    dset.CIFAR10(root='/root/autodl-tmp/sunbing/workspace/uap/data/cifar10//data', train=False, download=True, transform=transform_train),
    batch_size=args.bs, shuffle=False, sampler=None,
    num_workers=2, pin_memory=True)

test_loader = torch.utils.data.DataLoader(
    dset.CIFAR10(root='/root/autodl-tmp/sunbing/workspace/uap/data/cifar10//data', train=False, download=True, transform=transform_test),
    batch_size=args.bs, shuffle=False, sampler=None,
    num_workers=2, pin_memory=True)
